...
public final class RTree<T> {
    ...
    public static void main(String[] args) {
		RTree<Integer> r = new RTree<>(5, 3, 2);
		r.insert(new float[] {0,0}, new float[] {3,2}, 1);
		r.insert(new float[] {-1,-3}, new float[] {4,2}, 2);
		r.insert(new float[] {6,4}, new float[] {2,7}, 3);
		r.insert(new float[] {7,7}, new float[] {4,4}, 4);
		r.insert(new float[] {3,5}, new float[] {6,9}, 5);
		r.insert(new float[] {10,10}, new float[] {3,4}, 6);
		r.insert(new float[] {8,12}, new float[] {7,5}, 7);
		System.out.println(r.visualize());
	}
}